...
class MainActivity : AppCompatActivity() {
    ...
    private fun setViewElements() {
        ...
        val resultText = when (lemonadeState) {
            SELECT -> "Cliquez pour sélectionner un citron !"
            SQUEEZE -> "Cliquez pour presser le citron !"
            DRINK -> "Cliquez pour boire votre citronnade !"
            RESTART -> "Cliquez pour recommencer."
            else -> "bug"
        }
        textAction.text=resultText
        ...
        val drawableResource = when (lemonadeState) {
            ...
            else -> R.drawable.ic_launcher_lemonade_background
        }
